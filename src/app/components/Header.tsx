...
export default function Header(): JSX.Element {
  ...
  return (
    <header className="bg-gradient-to-r from-orange-300 via-yellow-200 to-orange-300
     text-black font-extrabold hover:text-red-600 py-4">
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden ${isOpen ? "block" : "hidden"} text-black p-4`}
      >
